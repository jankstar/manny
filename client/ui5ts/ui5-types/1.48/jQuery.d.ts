...
declare interface JQueryStatic {
     ...
     * @param {number} idx - optional parameter to return the control instance at the given idx's position in the array.
     ...
     */
    control(idx?: number): sap.ui.core.Control[]|sap.ui.core.Control|null;
     ...
     * @returns {number|JQuery} The cursor position (or the jQuery collection if the position has been set)
     */
    cursorPos(iPos: number): number|JQuery;
...
declare interface JQuerySap {
     ...
     * @returns {{type:string,index:number}[]} List of update operations
     */
    arraySymbolDiff(aOld: any[], aNew: any[], fnSymbol?: Function): {type:string,index:number}[];
     ...
     */
    assert(bResult: boolean, vMessage: string|Function): void;
     ...
     * @param {string|any} method - function pointer or name of the method
     * @param {any[]} aParameters - Method parameters
     * @returns {string} Id which can be used to cancel the timer with clearDelayedCall
     */
    delayedCall(iDelay: number, oObject: any, method: string|any, aParameters?: any[]): string;
     ...
     * @returns {string[]} the names of all declared modules
     */
    getAllDeclaredModules(): string[];
     ...
     * @param {string|any} vUrl - the URL of the script to load or a configuration object
     * @param {string|any} vId - id that should be used for the script tag or map of attributes
     ...
     * @returns {void|Promise<any>} When using the configuration object a <code>Promise</code> will be returned. The            documentation for the <code>fnLoadCallback</code> applies to the <code>resolve</code>            handler of the <code>Promise</code> and the one for the <code>fnErrorCallback</code>            applies to the <code>reject</code> handler of the <code>Promise</code>.
     */
    includeScript(vUrl: string|any, vId?: string|any, fnLoadCallback?: Function, fnErrorCallback?: Function): void|Promise<any>;
     ...
     * replaced.
     * @param {string|any} vUrl - the URL of the stylesheet to load or a configuration object
     * @param {string|any} vId - id that should be used for the link tag or map of attributes
     ...
     * @returns {void|Promise<any>} When using the configuration object a <code>Promise</code> will be returned. The            documentation for the <code>fnLoadCallback</code> applies to the <code>resolve</code>            handler of the <code>Promise</code> and the one for the <code>fnErrorCallback</code>            applies to the <code>reject</code> handler of the <code>Promise</code>.
     */
    includeStyleSheet(vUrl: string|any, vId?: string|any, fnLoadCallback?: Function, fnErrorCallback?: Function): void|Promise<any>;
     ...
     */
    intervalCall(iInterval: number, oObject: any, method: string|any, aParameters?: any[]): string;
     ...
     * @param {string|any} vUrlPrefix - path prefix to register, either a string literal or an object (e.g. {url : 'url/to/res', 'final': true})
     */
    registerModulePath(sModuleName: string, vUrlPrefix: string|any): void;
     ...
     * @param {string|any} vUrlPrefix - prefix to use instead of the sResourceNamePrefix, either a string literal or an object (e.g. {url : 'url/to/res', 'final': true})
     */
    registerResourcePath(sResourceNamePrefix: string, vUrlPrefix: string|any): void;
     ...
     * @param {string|any} vModuleName - one or more names of modules to be loaded                              or in case of an object {modName: "...", type: "..."}                              where modName is the name of the module and the type                              could be a specific dot separated extension e.g.                              <code>{modName: "sap.ui.core.Dev", type: "view"}</code>                              loads <code>sap/ui/core/Dev.view.js</code> and                              registers as <code>sap.ui.core.Dev.view</code>
     */
    require(vModuleName: string|any): void;
     ...
     * @param {string|any} data - request parameters in the format accepted by jQuery.ajax()
     * @param {string} sDataType - the type of data expected from the server, default is "text"
     * @returns {any} result @see jQuery.sap.sjax
     */
    syncGet(sUrl: string, data: string|any, sDataType?: string): any;
     ...
     * @returns {any} result @see jQuery.sap.sjax
     */
    syncGetJSON(sUrl: string, data: string|any, fallback?: any): any;
     ...
     * @returns {any} result @see jQuery.sap.sjax
     */
    syncGetText(sUrl: string, data: string|any, fallback?: string): any;
     ...
     * @returns {any} result @see jQuery.sap.sjax
     */
    syncPost(sUrl: string, data: string|any, sDataType?: string): any;
     ...
     */
    syncStyleClass(sStyleClass: string, vSource: JQuery|sap.ui.core.Control|string, vDestination: JQuery|sap.ui.core.Control): JQuery|Element;
...
declare class JQuerySapHistory {
     ...
     */
    public addHistory(sIdf: string, oStateData: any, bBookmarkable: boolean, bVirtual?: boolean): string;
     ...
     */
    public addRoute(sIdf: string, fn: Function, oThis?: any): any;
     ...
     */
    public back(iSteps?: number): void;
     ...
     */
    public backThroughPath(sPath: string): void;
     ...
     */
    public backToHash(sHash: string): void;
     ...
     */
    public setDefaultHandler(fn: Function): void;
...
declare class JQuerySapLogLogger {
     ...
     */
    public constructor(sDefaultComponent: string);
     ...
     * @returns {JQuerySapLogLogger} The log instance
     */
    public debug(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): JQuerySapLogLogger;
     ...
     * @returns {JQuerySapLogLogger} The log instance
     */
    public error(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): JQuerySapLogLogger;
     ...
     * @returns {JQuerySapLogLogger} The log instance for method chaining
     */
    public fatal(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): JQuerySapLogLogger;
     ...
     * @returns {JQuerySapLogLogger} The log instance
     */
    public info(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): JQuerySapLogLogger;
     ...
     * @returns {JQuerySapLogLogger} This logger object to allow method chaining
     */
    public setLevel(iLogLevel: JQuerySapLogLevel, sComponent?: string): JQuerySapLogLogger;
     ...
     * @returns {JQuerySapLogLogger} The log-instance
     */
    public trace(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): JQuerySapLogLogger;
     ...
     * @returns {JQuerySapLogLogger} The log instance
     */
    public warning(sMessage: string, sDetails?: string, sComponent?: string, fnSupportInfo?: Function): JQuerySapLogLogger;
...
declare interface JQuerySapMeasure {
     ...
     * @param {string|string[]} aCategories - An optional list of categories for the measure
     ...
     */
    add(sId: string, sInfo: string, iStart: number, iEnd: number, iTime: number, iDuration: number, aCategories?: string|string[]): any;
     ...
     */
    average(sId: string, sInfo: string, aCategories?: string|string[]): any;
     ...
     * }</code>
     * @param {Function} fnFilter - a filter function that returns true if the passed measurement should be added to the result
     * @param {boolean|any} bCompleted - Optional parameter to determine if either completed or incomplete measurements should be returned (both if not set or undefined)
     ...
     */
    filterMeasurements(fnFilter?: Function, bCompleted?: boolean|any, aCategories?: string[]): any;
     ...
     * @param {string[]} aCategories - An optional categories list for the measurement
     * @returns {boolean} true if the registration was successful
     */
    registerMethod(sId: string, oObject: any, sMethod: string, aCategories?: string[]): boolean;
     ...
     * @returns {boolean} current state of the perfomance measurement functionality
     */
    setActive(bOn: boolean, An: string|string[]): boolean;
     ...
     * @returns {any} current measurement containing id, info and start-timestamp (false if error)
     */
    start(sId: string, sInfo: string, aCategories?: string|string[]): any;
...
declare interface JQuerySapUtilProperties {
     ...
     * @returns {JQuerySapUtilProperties} A clone of the property collection
     */
    clone(): JQuerySapUtilProperties;
...
declare class JQuerySapVersion {
     ...
     * @param {number|string|any[]|JQuerySapVersion} vMajor - the major part of the version (int) or any of the single        parameter variants explained above.
     ...
     */
    public constructor(vMajor: number|string|any[]|JQuerySapVersion, iMinor: number, iPatch: number, sSuffix: string);
     ...
     * @param {string|any[]|JQuerySapVersion} vMin - the start of the range (inclusive)
     * @param {string|any[]|JQuerySapVersion} vMax - the end of the range (exclusive)
     ...
     */
    public inRange(vMin: string|any[]|JQuerySapVersion, vMax: string|any[]|JQuerySapVersion): boolean;
